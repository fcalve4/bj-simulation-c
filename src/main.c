...
// DECLARE CONSTANTS (WILL BE USER INPUT FROM THE COMMAND LINE via flags
// [IMPLEMENTED LATER]
#define NUM_DECKS 6
...
int main(int argc, char *argv[]) {
  ...
  Metadata metadata = {NUM_DECKS, H17,        LS,     DAS, RSA,
                       ENHC,      MAX_SPLITS, BJ_PAY, PEN, NUM_SIMULATIONS,
                       BANKROLL,  WAGER,      WAGER,  0,   0,
                       0,         0,          0};
